...
use App\Http\Requests\Backend\Main\ConfigurationTheme\StoreRequest;
use App\Http\Requests\Backend\Main\ConfigurationTheme\UpdateRequest;
...
class ConfigurationThemeController extends Controller {
  ...
  **/
  ...
  public function __construct() {
    ...
    $this->url = '/dashboard/configuration/themes';
    $this->path = 'pages.backend.main.configuration.theme';
    $this->model = 'App\Models\Backend\Main\ConfigurationTheme';
